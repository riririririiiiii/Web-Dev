...
export class AppComponent {
  categories: string[] = ['Мелкая техника для кухни', 'Малая техника для дома', 'Климатическая техника', 'Крупная техника для дома'];
  products: Product[] = [
    new Product(1, 'Пылесос Deerma DX700 белый', 'стильный, компактный и удобный пылесос', '14 980', 'https://resources.cdn-kaspi.kz/img/m/p/hdb/h2f/63803859566622.jpg?format=gallery-medium', 5, 'https://kaspi.kz/shop/p/deerma-dx700-belyi-3701383/?c=750000000', 'Малая техника для дома', 0),
  ...
  removeProduct(product: Product): void {
    this.displayedProducts = this.displayedProducts.filter(p => p.id !== product.id);
  }
  ...
  sharing(id: number): void {
    ...
    if (product) {
      const encodedLink = encodeURIComponent(product.sourceLink ?? '');
